...
func TestCustomRKE2Dualstack(t *testing.T) {
	...
	tests := []struct {
		...
		{"RKE2_Dual_Stack_Custom_Windows_IPv4_Stack_Preference", r.standardUserClient, nodeRolesDedicatedWindows, ipv4StackPreference},
		{"RKE2_Dual_Stack_Custom_Dual_Stack_Preference", r.standardUserClient, nodeRolesStandard, dualStackPreference},
		{"RKE2_Dual_Stack_Custom_Windows_Dual_Stack_Preference", r.standardUserClient, nodeRolesDedicatedWindows, dualStackPreference},
		{"RKE2_Dual_Stack_Custom_CIDR_Dual_Stack_Preference", r.standardUserClient, nodeRolesStandard, cidrDualStackPreference},
		{"RKE2_Dual_Stack_Custom_Windows_CIDR_Dual_Stack_Preference", r.standardUserClient, nodeRolesDedicatedWindows, cidrDualStackPreference},
	}
