...
func (u *UpgradeKubernetesTestSuite) SetupSuite() {
	...
	u.rke2ClusterID, err = resources.ProvisionRKE2K3SCluster(u.T(), u.standardUserClient, extClusters.RKE2ClusterType.String(), u.rke2ClusterConfig, false, false)
	require.NoError(u.T(), err)

	u.k3sClusterID, err = resources.ProvisionRKE2K3SCluster(u.T(), u.standardUserClient, extClusters.K3SClusterType.String(), u.k3sClusterConfig, false, false)
	require.NoError(u.T(), err)
}
...
func (u *UpgradeKubernetesTestSuite) TestUpgradeKubernetes() {
	tests := []struct {
		...
		{"Upgrading RKE2 cluster from ", u.rke2ClusterID, u.rke2ClusterConfig, extClusters.RKE2ClusterType.String()},
		{"Upgrading K3S cluster from ", u.k3sClusterID, u.k3sClusterConfig, extClusters.K3SClusterType.String()},
	}
	...
	for _, tt := range tests {
		...
		tt.name += updatedCluster.Spec.KubernetesVersion + " to " + tt.clusterConfig.KubernetesVersion
